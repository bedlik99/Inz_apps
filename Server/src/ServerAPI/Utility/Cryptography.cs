...
namespace ServerAPI.Utility
{
	...
	{
		//TBD - Set these in appsettings.json
		private readonly IOptions<CryptographySettings> _settingsAccesor;

		public Cryptography(IOptions<CryptographySettings> settingsAccessor)
		{
